const reportData = {
  ...
  highlights: [
    {
      title: "产品架构设计完整清晰",
      points: [
        "核心模块规划合理，选股功能、盯盘功能、持仓查询等功能划分明确",
        "财小安IP形象统一，品牌识别度高",
        "从信息查询到辅助决策的产品思路清晰"
      ]
    },
    ...
    },
    {
      ...
      points: [
        ...
        "试图整合多维度信息（收盘数据、消息面、技术面、情绪面等综合分析）",
  ...
  issues: [
    ...
    },
    {
      ...
      module: "盯盘功能",
      title: "来源引用标注错误",
      description: "“何帆教授“九层股市利益金字塔”理论”段落引用来源标注为\"④\"，但点击后看到④的内容与此无关，真正有关的是第九条引用来源",
      time: "2026-04-06 23:18",
    ...
    },
    {
      ...
      module: "选股功能",
      title: "语音播放时希望高亮当前句子",
      description: "语音播放回复消息时，希望可以将当前阅读的句子高亮，方便长文本阅读时进行位置定位\n\n很多专业性的分析结果内容中包含大量专有名词和缩写，TTS输出的结果可能会出现错误或与用户预期发音不同的情况，此时可以快速定位到所读句子将可以更好地辅助理解模型输出内容",
      time: "",
      screenshots: [],
      videos: [],
      steps: [],
